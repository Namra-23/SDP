...
void main(List<String> arguments) {
  ...
  */
  ...
  const desserts = [
    ...
    'God',
    'Great'
  ]; //This is same as , final desserts = const['Joshi','God','Great'];
  ...
  */
  ...
  // Challenge 1:
  String para =
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Praesentium dicta sed quidem odit at officia labore cumque, animi aliquam nihil culpa fugiat possimus id odio itaque inventore amet voluptate et eaque incidunt eveniet, porro perferendis? Debitis quos cumque deserunt at culpa nesciunt tempore officia odio, illum pariatur harum quis quisquam exercitationem aliquam doloremque minima incidunt accusamus..";
  ...
  // Challenge 3:
  User user1 = User(1, 'Namra');
  User user2 = User(2, 'Joshi');
